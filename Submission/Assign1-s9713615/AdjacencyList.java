...
public class AdjacencyList extends AbstractGraph
{
    ...
    public String[] kHopNeighbours(int k, String vertLabel) {
    	...
    	if (!map.containsKey(vertLabel)) {
    		...
    		//call the recursive helper function to iterate through the neighbours
     ...
     * @param key
     * @param sArray
     * @return returns an array of neighbours based on number of khops and initial key
     */
    ...
    public Edge[] getEdges() {
    	...
    	//iterate through the entire list of vertices, create the edge objects and store them in 
    	//and array for return 
    	for (String n: map.keySet()) {
    		LinkedList<String> printList = adjList.getObject(map.get(n).getIndexPointer());
    		Node<String> printNode = printList.getHead();
