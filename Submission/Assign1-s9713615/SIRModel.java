    ...
    public void runIterationSimulation(ContactsGraph graph, String[] seedVertices,
            float infectionProb, float recoverProb, PrintWriter sirModelOutWriter)
        {
        	...
        	while (!stopCondition) {
        		...
        		sirModelOutWriter.println(infectionProb + "," + recoverProb + "," + vertexSize + "," + edgeSize + "," + counter + "," 
        				+ currentTotalInfections + "," +  sList.getNewlyInfectedTotal() + "," + sList.getNewlyRecoveredTotal());
